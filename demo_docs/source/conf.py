...
copyright = u'2013, Dave Snider, 2016, RealTimeCat'
...
latex_documents = [
  ('index', 'rtcatsphinxthemedemo.tex', u'RTCat Sphinx theme demo Documentation',
   u'Dave Snider, RealTimeCat', 'manual'),
]
...
texinfo_documents = [
  ('index', 'rtcatsphinxthemedemo', u'RTCat Sphinx theme demo Documentation',
   u'Dave Snider, RealTimeCat', 'rtcatsphinxthemedemo', 'One line description of project.',
   'Miscellaneous'),
]
