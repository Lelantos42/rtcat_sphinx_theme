  ...
  grunt.initConfig({
        ...
        files: [
          {
              ...
              dest: 'rtcat_sphinx_theme/static/fonts/',
              filter: 'isFile'
          },
          {
              expand: true,
    ...
    sass: {
      dev: {
        ...
        files: [{
          ...
          cwd: 'sass',
          src: ['*.sass'],
          dest: 'rtcat_sphinx_theme/static/css',
          ext: '.css'
        }]
      },
      build: {
    ...
    browserify: {
      dev: {
        ...
        src: ['js/*.js'],
        dest: 'rtcat_sphinx_theme/static/js/theme.js'
      },
      build: {
        options: {
          external: ['jquery'],
    ...
    clean: {
      ...
      fonts: ["rtcat_sphinx_theme/static/fonts"]
    },
    ...
    watch: {
      ...
      sphinx: {
        files: ['rtcat_sphinx_theme/**/*', 'demo_docs/**/*.rst', 'demo_docs/**/*.py'],
